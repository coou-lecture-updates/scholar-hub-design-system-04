...
import { Send, Paperclip, Smile, Hash, ChevronDown, ChevronUp } from 'lucide-react';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
    ...
    <div className="space-y-0 bg-card rounded-lg border border-border/50 overflow-hidden focus-within:border-primary/50 transition-all">
      ...
      <div className="relative">
        <Textarea
          ...
          className="min-h-[60px] md:min-h-[70px] pr-12 resize-none text-sm border-0 focus-visible:ring-0 focus-visible:ring-offset-0 bg-transparent p-3"
          maxLength={1000}
        />

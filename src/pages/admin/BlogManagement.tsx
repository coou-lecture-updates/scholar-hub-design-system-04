          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto px-1">
                <form onSubmit={handleSaveBlog} className="space-y-4 pb-4">
                <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div>
                    <FileUploadField
                      label="Blog Image"
                      onFileUploaded={(url) => setBlogForm(prev => ({ ...prev, image_url: url }))}
                      value={blogForm.image_url}
                      placeholder="Add a featured image for your blog post"
                      accept="image/*"
                      maxFileSize={5}
              ...
              <DialogFooter className="flex-shrink-0 sticky bottom-0 bg-white border-t pt-4">
                ...
                <Button type="submit" disabled={loading} onClick={handleSaveBlog} className="flex-1">
